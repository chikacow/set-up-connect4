...
pub struct Solver {
    ...
    opening_database: Option<Arc<OpeningDatabase>>,
}
...
impl Solver {
    ...
    pub fn new_with_transposition_table(
        ...
        Self {
            board,
            node_count: 0,
            transposition_table: Arc::new(Mutex::new(transposition_table)),
            opening_database: None,
        }
    }
    ...
    pub fn with_opening_database(mut self, opening_database: OpeningDatabase) -> Self {
        self.opening_database = Some(opening_database.into());
        self
    }
    ...
    fn negamax(&mut self, mut alpha: i32, mut beta: i32) -> i32 {
        ...
        let value = self.transposition_table.lock().unwrap().get(key) as i32;
        if value != 0 {
